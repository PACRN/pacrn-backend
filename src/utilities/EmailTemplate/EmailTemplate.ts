...
export const PasswordResetTemplate = (firstName: string, url: string) => {
  const htmlTemplate = `
        <!DOCTYPE html>
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 174px;"><img
                                                                            src="https://www.spot.care/static/media/full.43b96d0f5e7320fec90a.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="174" alt title height="auto"></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    ...
                                                                    <span class="tinyMce-placeholder"
                                                                        style="word-break: break-word;">Password
                                                                        Reset</span></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="paragraph_block block-5" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#000000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0; margin-bottom: 16px;">We
                                                                        received a request to reset the password of your
                                                                        Spot care account.</p>
                                                                    <p style="margin: 0;">Click the link below to reset
                                                                        password.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">If you
                                                                        ...
                                                                        action is required, and your password will not
                                                                        be changed.</p>
                                                                    <p style="margin: 0;">For security purposes, please
                                                                        do not share this email or your password reset
                                                                        link with anyone</p>
                                                                </div>
                                                            </td>
                                                        </tr>
